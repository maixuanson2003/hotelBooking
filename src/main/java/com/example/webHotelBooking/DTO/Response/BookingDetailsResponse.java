...
public class BookingDetailsResponse {
    ...
    public  BookingDetailsResponse(bookingdetails booking){
        ...
        this.hotelRoom=new HotelRoomDTO(booking.getHotelRoom().getAmountRoom(),booking.getHotelRoom().getTypeRoom(),booking.getHotelRoom().getStatus(),booking.getHotelRoom().getNumberPeople(),booking.getHotelRoom().getFloorNumber(),booking.getHotelRoom().getPricePerNight(),booking.getHotelRoom().getImage());
    }
}
